 ...
 * @author jjdg46
 */
public class TercerosControllerGUI {
    ...
    private void actionAdd() {
        try {
            ...
            Logger.getLogger(TercerosControllerGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        TercerosControllerGUI tercerosController = new TercerosControllerGUI();
